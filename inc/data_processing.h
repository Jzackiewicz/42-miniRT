...
int									is_valid_float(const char *str, int i,
										int has_dot, int has_digit);
...
void								parse_colors(char *color,
										t_input_data *obj);
void								parse_vector(char *vector,
										t_input_data *obj);
void								parse_coords(char *coords,
										t_input_data *obj);
